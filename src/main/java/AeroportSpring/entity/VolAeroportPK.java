...
@Embeddable
public class VolAeroportPK implements Serializable  {
	@ManyToOne
	...
	public VolAeroportPK() {
		super();
	}


	public VolAeroportPK(Vol vol, Aeroport aeroport) {
		super();
		this.vol = vol;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VolAeroportPK other = (VolAeroportPK) obj;
		if (aeroport == null) {
